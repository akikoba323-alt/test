...
export const since = (t, a, d = 0.5, e = E.outCubic) => (t <= a ? 0 : t >= a + d ? 1 : e((t - a) / d));
// 0..1 pulse that rises at a and decays
export const pulse = (t, a, rise = 0.05, decay = 0.4) => (t < a ? 0 : t < a + rise ? (t - a) / rise : Math.exp(-(t - a - rise) / decay));
